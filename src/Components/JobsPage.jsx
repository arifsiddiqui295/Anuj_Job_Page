...
import Smalldis from "./smalldis";
import Completedis from "./Completedis";
...
export default function JobsPage(props) {
  ...
  return (
    <>
      <div className="max-h-screen hidden bg-[#f7f9ff] ite gap-7 text-black md:flex flex-wrap pl-14 pr-14 w-full pt-3">
        {/* Left section */}
